...
use frontend\models\USystemProject;
...
class AdController extends Controller
{
    ...
    public function actionGetall(){
        ...
        $project_where['appid'] = $post['appid'];
        //查询项目ID
        $project = USystemProject::_get_info($project_where)->attributes; 
        //
    }
    /** 
     * 获取商城首页推荐位
    ...
    {       
        ...
        $list = (new UniversalDb('db'))->setTableName('system_recommend_rel')
                 ->find()
                 ->select('title,thumb,recommend_type,target_id,target_url')
