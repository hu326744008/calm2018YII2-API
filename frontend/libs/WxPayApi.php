...
use Yii;
require_once Yii::$app->basePath."/libs/wechatpay/WxPay.Exception.php";
require_once Yii::$app->basePath."/libs/wechatpay/WxPay.Config.php";
require_once Yii::$app->basePath."/libs/wechatpay/WxPay.Data.php";
